...
map.getView().fit([-13615360.400935, 4562261.798775, -13606164.973807, 4569451.125413], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Fuel Break II El Cerrito thru Berkeley: Protected NSI Structures within .25 Mile</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (376 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Fuel Break II El Cerrito thru Berkeley: Protected NSI Structures within a .25 Mile Buffer<br /><br />Based on a proposed Fuel Break defined in Google My Maps:<br />   Fuel Break II El Cerrito thru Kensington<br />   Fuel Break II Berkeley only<br />as of 2025-11-26.<br /><br />Note: there are a few structures included here to the northeast of the proposed fuel break as well as to the due west and due south.<br />';
            }
